            ...
            <form action="" method="post" style="width: 70vw; min-width: 300px;">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type ="text" class="form-control" name="name" placeholder="Jewells Hije" disabled>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type ="text" class="form-control" name="email" placeholder="jewellshije@gmail.com" disabled>
                    </div>

                    <div class="col">
                        <label class="form-label"> Password </label>
                        <input type ="text" class="form-control" name="pass" placeholder="admin1234" disabled>
                    </div>

                    
                    <div class="col">
                        <label class="form-label"> Role </label>
                        <input type ="text" class="form-control" name="role" placeholder="Disabled input" disabled>
                    </div>
                </div>
